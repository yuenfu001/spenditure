...
const MobileNav = () => {
  return (
    <div>
      ...
      <nav
        id="nav"
        class="d-block d-sm-block d-md-none d-lg-none fixed-bottom nav d-flex justify-content-center flex-row nav-tabs mt-0 bg-light"
      >
        <div class="nav-item">
          <a
            class="nav-link menu-list d-flex flex-column text-center"
            href="./home.html"
          >
            <div>
              <svg
        ...
        <div id="pop-menu" class="nav-item position-relative">
          <span
            class="nav-link d-flex flex-column position-absolute"
        ...
        <div class="nav-item">
          <a class="nav-link menu-list d-flex flex-column text-center" href="">
            <div>
              <svg
                width="25"
                height="24"
      ...
      "
      >
        <div class="d-flex text-white align-items-center justify-content-center p-4">
          <img src="/Images/Add-icon.svg" alt="" />
          <p>Add transaction</p>
        </div>

        <div id="nav" class="nav d-flex flex-column nav-tabs ps-5">
          <div class="nav-item py-3">
            <a
              class="nav-link menu-list"
          ...
          <div class="nav-item py-3">
            ...
            >
              ...
              <span style="margin-left: 10px">Tracker</span>
            </a>
          </div>
          <div class="nav-item py-3">
            <a
            ...
            >
              ...
              <span style="margin-left: 10px">Budget</span>
            </a>
          </div>
          <div class="nav-item py-3 pb-5">
            <a
              class="nav-link menu-list"
              style="padding: 5px; display: flex"
              href="./account.html"
